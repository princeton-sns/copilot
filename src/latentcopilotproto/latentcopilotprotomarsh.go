...
func (t *PreAccept) Unmarshal(rr io.Reader) error {
	...
	t.ViewId = int32((uint32(bs[12]) | (uint32(bs[13]) << 8) | (uint32(bs[14]) << 16) | (uint32(bs[15]) << 24)))
	t.Ballot = int32((uint32(bs[16]) | (uint32(bs[17]) << 8) | (uint32(bs[18]) << 16) | (uint32(bs[19]) << 24)))
	...
	t.DepViewId = int32((uint32(bs[0]) | (uint32(bs[1]) << 8) | (uint32(bs[2]) << 16) | (uint32(bs[3]) << 24)))
	return nil
}
...
func (t *Accept) Unmarshal(rr io.Reader) error {
	...
	t.ViewId = int32((uint32(bs[16]) | (uint32(bs[17]) << 8) | (uint32(bs[18]) << 16) | (uint32(bs[19]) << 24)))
	alen1, err := binary.ReadVarint(wire)
	if err != nil {
		return err
	}
...
func (t *AcceptReply) Unmarshal(wire io.Reader) error {
	...
	t.OK = uint8(bs[8])
	t.ViewId = int32((uint32(bs[9]) | (uint32(bs[10]) << 8) | (uint32(bs[11]) << 16) | (uint32(bs[12]) << 24)))
	t.Ballot = int32((uint32(bs[13]) | (uint32(bs[14]) << 8) | (uint32(bs[15]) << 16) | (uint32(bs[16]) << 24)))
	t.DepSeen = uint8(bs[17])
	return nil
}
...
func (t *PrepareReply) Unmarshal(rr io.Reader) error {
	...
	t.Instance = int32((uint32(bs[8]) | (uint32(bs[9]) << 8) | (uint32(bs[10]) << 16) | (uint32(bs[11]) << 24)))
	t.OK = uint8(bs[12])
	t.ViewId = int32((uint32(bs[13]) | (uint32(bs[14]) << 8) | (uint32(bs[15]) << 16) | (uint32(bs[16]) << 24)))
	t.Ballot = int32((uint32(bs[17]) | (uint32(bs[18]) << 8) | (uint32(bs[19]) << 16) | (uint32(bs[20]) << 24)))
	t.Status = int8(bs[21])
	alen1, err := binary.ReadVarint(wire)
	if err != nil {
		return err
	...
	t.NullDepSafe = uint8(bs[0])
	t.DepViewId = int32((uint32(bs[1]) | (uint32(bs[2]) << 8) | (uint32(bs[3]) << 16) | (uint32(bs[4]) << 24)))
	return nil
}
...
func (t *PreAcceptReply) Unmarshal(rr io.Reader) error {
	...
	t.DepSeen = uint8(bs[0])
	t.CmdCommitted = uint8(bs[1])
	return nil
}
